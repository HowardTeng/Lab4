...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (tempPokemon.hitPoints < 1 || tempPokemon.hitPoints > MAX_HIT_POINTS) {
            tempPokemon.hitPoints = k.nextInt();
        ...
        System.out.println("Enter the attack level (1-" + (MAX_HIT_POINTS - 1) + "):");
        while (tempPokemon.attackLevel < 1 || tempPokemon.attackLevel > MAX_HIT_POINTS - 1) {
            tempPokemon.attackLevel = k.nextInt();
            if (tempPokemon.attackLevel < 1 || tempPokemon.attackLevel > MAX_HIT_POINTS - 1) {
                System.out.println("Sorry. The attack level must be between 1 and " + (MAX_HIT_POINTS - 1) + "):");
            }
        }
        System.out.println("Enter the defense level (1-" + (MAX_HIT_POINTS - tempPokemon.attackLevel) + "):");
        while (tempPokemon.defenseLevel < 1 || tempPokemon.defenseLevel > MAX_HIT_POINTS - tempPokemon.attackLevel) {
            tempPokemon.defenseLevel = k.nextInt();
